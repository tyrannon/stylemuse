...
export const styles = StyleSheet.create({
  ...
  slotSortButtonTextActive: {
    color: '#e3f2fd',
  },
  slotSortOptionsContainer: {
    backgroundColor: 'white',
    borderRadius: 12,
    marginBottom: 15,
    shadowColor: '#000',
  ...
  slotSortOptionActive: {
    backgroundColor: '#e3f2fd',
  },
  slotSortOptionContent: {
    flexDirection: 'row',
    alignItems: 'center',
    flex: 1,
  },
