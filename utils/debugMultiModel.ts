...
export async function generateDebugMultiModelOutfits(): Promise<{
  results: Array<{
    model: AIModel;
  ...
  try {
    ...
    logger.error(LogCategories.OUTFIT_GENERATION, '❌ Debug multi-model generation failed', error as Error, {
      errorMessage,
